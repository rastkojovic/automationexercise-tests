...
def test_contact_form(driver):
    ...
    homepage_h1_title = home_page.get_h1_text()
    ...
    assert homepage_h1_title == test_data.HOMEPAGE_H1_TEXT, f"Expected H1 text: '{test_data.HOMEPAGE_H1_TEXT}', actual H1 text: {homepage_h1_title}"
